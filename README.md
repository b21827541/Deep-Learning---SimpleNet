...
## Project Overview
This repository contains my implementation of the [SimpleNet paper](https://openaccess.thecvf.com/content/CVPR2023/papers/Liu_SimpleNet_A_Simple_Network_for_Image_Anomaly_Detection_and_Localization_CVPR_2023_paper.pdf) using PyTorch and Distributed Data Parallel (DDP) for efficient multi-GPU training. SimpleNet is a lightweight convolutional neural network architecture for image anomaly detection and localization.
